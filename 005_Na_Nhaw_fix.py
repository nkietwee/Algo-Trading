...
previous_portfolio_filename = f"005_Na_Nhaw_portfolio.csv"
previous_statement_filename = f"005_Na_Nhaw_statement.csv"
previous_summary_filename = f"005_Na_Nhaw_summary.csv"
...
if day_test == first_day or day_test == date(2024, 11, 19):
    ...
    initial_cash = p_summary['end_line_available'][0]
...
# Define file names with required naming convention
portfolio_filename = f"005_Na_Nhaw_portfolio.csv"
statement_filename = f"005_Na_Nhaw_statement.csv"
summary_filename = f"005_Na_Nhaw_summary.csv"
